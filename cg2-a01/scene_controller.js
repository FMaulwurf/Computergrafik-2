...
define(["util", "scene", "jquery", "straight_line", "circle", "parametric_curve", "bezier_curve"],
    (function (util, Scene, $, StraightLine, Circle, ParametricCurve, BezierCurve) {
         ...
         *
         */
        SceneController.prototype.onObjChange = function () {
        ...
        SceneController.prototype.select = function (obj) {
            ...
            $('#width').val(obj.lineStyle.width);
            $('#color').val(obj.lineStyle.color);
        ...
        SceneController.prototype.mousemove = function (event) {
            ...
            if (this.isDragging) {
                ...
                // call the object's handler function, if existing
                var dragEvent = {"position": pos, "delta": [deltax, deltay], "radius": 0};
