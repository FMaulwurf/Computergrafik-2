    ...
    var HtmlController = function(scene,animation,keyMap) {
        ...
        var updateParams = function() {
            ...
            if( $("#anim_Toggle").attr("checked") == undefined ) {
                animation.rotateWorld.stop();
            } else {
                animation.rotateWorld.resume();
            };

            // set animation speed
            animation.rotateWorld.customSpeed = parseFloat($("#anim_Speed").attr("value"));

            if( $("#anim_robo_Toggle").attr("checked") == undefined ) {
                animation.rotateRoboter.stop();
            } else {
                animation.rotateRoboter.resume();
            };

            // set animation speed
            animation.rotateRoboter.customSpeed = parseFloat($("#anim_Speed").attr("value"));
