...
define(["gl-matrix", "program", "scene_node", "shaders", "directional_light", "material", "texture",
        "models/cube", "models/parametricSurface"],
    (function(glmatrix, Program, SceneNode, shaders, DirectionalLight, Material, texture,
        ...
        var Scene = function(gl) {
            ...
            this.materials.planet.setUniform( "material.ambient",   "vec3", [0,0,0] );
            ...
            //textures
            this.earthDay = new texture.Texture2D(gl, "textures/earth_month04.jpg");
            this.earthNight = new texture.Texture2D(gl, "textures/earth_at_night_2048.jpg");
            this.earthBathymetry = new texture.Texture2D(gl, "textures/earth_bathymetry_2048.jpg");
            this.earthTopography = new texture.Texture2D(gl, "textures/earth_topography_2048.jpg");
            this.earthClouds = new texture.Texture2D(gl, "textures/earth_clouds_2048.jpg");

            var scene = this;
            texture.onAllTexturesLoaded(function(){
                scene.programs.planet.use();
                scene.programs.planet.setTexture("daylightTexture", 0, scene.earthDay);
                scene.programs.planet.setTexture("nightlightTexture", 1, scene.earthNight);
                scene.programs.planet.setTexture("bathymetryTexture", 2, scene.earthBathymetry);
                scene.programs.planet.setTexture("topographyTexture", 3, scene.earthTopography);
                scene.programs.planet.setTexture("cloudsTexture", 4, scene.earthClouds);
                scene.draw();
            });
            ...
            mat4.rotateX(this.planetNode.transform(), Math.PI / 2);
        ...
        Scene.prototype.draw = function() {
            ...
            this.materials.planet.setUniform( "debug", "bool", this.drawOptions["Show Debug"] );
            this.materials.planet.setUniform("daylight", "bool", this.drawOptions["Daytime Texture"]);
            this.materials.planet.setUniform("nightlight", "bool", this.drawOptions["Nighttime Texture"]);
            this.materials.planet.setUniform("redgreen", "bool", this.drawOptions["Red Green"]);
            this.materials.planet.setUniform("bathymetry", "bool", this.drawOptions["Gloss Map"]);
